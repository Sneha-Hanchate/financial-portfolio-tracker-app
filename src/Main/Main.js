 ...
 class Main extends Component {
    ...
    removeStock=(index)=>{
        ...
        let companySymbol=this.state.myStocks[index]["Company_Symbol"];
            ...
            axios.post('https://finance-port-polio-track.firebaseio.com/Companies.json', {
                name:companyName,
            ...
            //Deleting stocks from my Stocks
             axios.delete(`https://finance-port-polio-track.firebaseio.com/mystocks/${id}.json`)
             .then((response)=>{
        ...
        addDatatoFirebase=(a,b,c)=>
        {
            ...
            let buyDate=document.getElementById("buyDate").value;
                    if(noofshares>0&&buyPrice.length>0&&buyDate.length>0)
                    {
                            ...
                            axios.post('https://finance-port-polio-track.firebaseio.com/mystocks.json', {
                            ...
                            axios.delete(`https://finance-port-polio-track.firebaseio.com/Companies/${id}.json`)
                            .then((response)=>{
